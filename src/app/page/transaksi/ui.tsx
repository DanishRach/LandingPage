  ...
  const handleSelectPlan = (layanan: layananProps) => {
    if (layanan !== undefined) {
      const data = {
        ...
        name: layanan.judul,
        price: layanan.potongan || layanan.harga, // Use discount price if available
              ...
              <div key={index} className={styles.plan}>
                ...
                <div className={styles.price}>
                  ...
                  {plan.judul === "Penetration test" ? (
                    ...
                    <>
                      {/* Harga dengan diskon */}
                      {plan.potongan !== null && plan.potongan !== undefined ? (
                        <div>
                          <span className={styles.diskon}>
                      ...
                      {plan.potongan !== null && plan.potongan !== undefined ? 
                        <div>
                          Rp {plan.potongan.toLocaleString("id-ID")} /bulan
                        </div>
                        :
                        <div >
                          Rp {plan.harga.toLocaleString("id-ID")} / bulan
                        </div>
                      }
                    </>
                  )}
